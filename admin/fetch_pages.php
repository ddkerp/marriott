...
if(isset($_POST) && isset($_SERVER['HTTP_X_REQUESTED_WITH']) && strtolower($_SERVER['HTTP_X_REQUESTED_WITH']) == 'xmlhttprequest'){
	...
	$stmt = $mysqli->prepare("SELECT c.*,(select name from venue where id=c.venue_id) as venue_name FROM contactus c ORDER BY c.id DESC LIMIT $page_position, $item_per_page");
	...
	$headers = array("S.No","","Name","","Mobile","Email Id","Comment","","","","IP Address","Contacted Date","Venue");
