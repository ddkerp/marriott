...
foreach($rows as $row){
 $list_block = $list_block.'<div class="col-md-4 col-sm-6 col-xs-12 col-xxs-12 filtr-item margin-B20 '.$row['city'].'" data-category="'.$row['city_id'].'" data-sort="'.$row['city'].'"> <a href="detail.php?id='.$row['id'].'">
